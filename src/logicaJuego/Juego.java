...
public class Juego {
	...
	/**
	 * Constrcutor de juego en el que indicamos el tipo de personaje por parametro,
	 * después hacemos un bucle para comparar el numero de jugadores, es decir el
	 * contador, con el limite, y lo creamos hasta que se llegue a este limite.
	 * También llamamos en el contructor al metodo que se encarga de crear el
	 * tablero.
	 * 
	 * @param personaje
	 */
	...
	/**
	 * Metodo para crear a un jugador en el cual se le introduce por paramtero el
	 * tipo que es y a la hora de crearlo compruebo que la coordenada no este
	 * ocupada, si esta no lo está, lo creo
	 * 
	 * @param tipo
	...
	/**
	 * Creo el tablero al cual lo unico que hago es llamar a los demás metodos los
	 * cuales van a asignar tanto rocas, como gemas,etc en las coordenadas del
	 * tablero, para de esta manera tenerlo con todos los elementos creados.
	 * 
	 */
	...
	/**
	 * Metodo para crear roca, el numero de rocas esta limitado por la constante
	 * NUM_ROCAS, para ello creamos un elemento y una coordenada en la cual en el
	 * tablero comprobamos que el valor clave, es null si este es el null, le
	 * ponemos la coordenada creada y el elemento e incrementamos el contador, hasta
	 * que el contador sea mayor que el limite.
	 * 
	 */
	...
	/**
	 * Metodo para crear dinero, hago un bucle en el cual incremento un contador,
	 * creo una coordenada y un elemento, y si la coordenada obtenida mediante el
	 * get es null, la añado, si no, pues aumento el contador;
	 */
	...
	/**
	 * Metodo para crear gemas, el numero de rocas esta limitado por la constante
	 * NUM_GEMAS, para ello creamos un elemento y una coordenada en la cual en el
	 * tablero comprobamos que el valor clave, es null si este es el null, le
	 * ponemos la coordenada creada y el elemento e incrementamos el contador, hasta
	 * que el contador sea mayor que el limite.
	 * 
	...
	/**
	 * Metodo para crear pociones, el numero de rocas esta limitado por la constante
	 * NUM_POCIONES, para ello creamos un elemento y una coordenada en la cual en el
	 * tablero comprobamos que el valor clave, es null si este es el null, le
	 * ponemos la coordenada creada y el elemento e incrementamos el contador, hasta
	 * que el contador sea mayor que el limite.
	 * 
	...
	/**
	 * Metodo para terminar el juego, el cual recorre los elementos del tablero, y
	 * comprueba si el elemento es una estancia de jugador y si lo es comprobamos si
	 * ha llegado al limite de dinero del juego el cual es 4, si es así acaba y
	 * ponemos la variable a true. Si no lo posee pero la longitud de la coordenada
	 * es igual a 1, también acabariamos el juego, por lo cual lo pondriamos a true.
	 * 
	...
	/**
	 * Metodo para imprimir jugadores, el cual declaramos un StringBuilder que va a
	 * ser lo que retorne el método, recorremos las coordenadas que posee la Lista,
	 * despues creamos u jugador y le realizamos el casteo para poder obtener su
	 * nombre y metemos en el StringBuilder su nombre y el numero de jugador.
	 * 
	...
	public String imprimeNombreJugadores() {
		...
		for (Coordenada coordenada : this.coordenadaJugadores) {
			...
			sb.append(
					"El tipo del jugador es: " + jugadores.getNombre() + " y es el jugador numero: " + contador + "\n");
			contador++;
		}
		return sb.toString();
	}
	...
	/**
	 * Metodo el cual cambia al jugador de posicion, se le pasa por parametro una
	 * coordenada, acto seguido se elimina al juagdor de la coordenada, y se
	 * actualiza cambiandolo de posicion, y se le vuelve a poner en el tablero.
	 * 
	 * @param coordenada
	 */
	...
	/**
	 * Metodo el cual imprime el valor de los elementos del jugadores, se realiza
	 * igual que el anterior solo que a este le sacamos los valores de los elementos
	 * del jugador.
	 * 
	...
	public String imprimeValoresJugadores() {
		...
		for (Coordenada coordenada : this.coordenadaJugadores) {
			...
			sb.append("Jugador numero: " + contador + " Dinero: " + jugador.getDinero() + " Gemas: "
					+ jugador.getGemas() + " Pociones: " + jugador.getPociones() + "\n");
			contador++;
		}
		return sb.toString();
	}
	...
	/**
	 * Metodo para mover al jugador, se le pasa por parametro un caracter, en
	 * funcion de la direccion en la cual quiere ir, una vez que se le pasa se llama
	 * a los metodos correspondientes para la subida, bajada o desplazamiento hacia
	...
	public String getGanador() {
		...
		if (this.coordenadaJugadores.size() == 1) {
			Jugador aux = (Jugador) tablero.get(coordenadaJugadores.get(0));
